...
const getTagsById = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json(new ApiResponse(200, tags, "tags by id feched successfully"))
})

const getAllTag = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json(new ApiResponse(200, tags, "tags feched successfully"))
})

const updateTags = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    const {name} = TagsSchema.parse(req.body)
    const {tagId} = req.params
    ...
    const tags = await Tags.findByIdAndUpdate(tagId, {
        $set: {
            name
        }   
    },{
    ...
    return res.status(200).json(new ApiResponse(200, tags, "tags updated successfully"))
})

const deleteTags = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    const {tagId} = req.params
