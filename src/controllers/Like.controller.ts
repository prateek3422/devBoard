...
const toggleBlogLike = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (like) {
      ...
      return res
        .status(200)
        .json(new ApiResponse(200, {}, "unlike blog successfully"));
    }
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, newLike, "like blog successfully"));
  }
);

const toggleQuestionLike = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (like) {
      ...
      return res
        .status(200)
        .json(new ApiResponse(200, {}, "unlike question successfully"));
    }
    ...
    return res
      .status(201)
      .json(new ApiResponse(200, newLike, "Like question successfully"));
  }
);

const toggleAnswerLike = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (like) {
      ...
      return res
        .status(200)
        .json(new ApiResponse(200, {}, "Answer unlike successfully"));
    }
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, newLike, "Answer Like successfully"));
  }
);
