...
const AddBlogComment = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, comment, "Add blog comment successfully"));
  }
);

const AddQuestionComment = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const { content } = commentSchema.parse(req.body);
    ...
    return res
      .status(200)
      .json(
        new ApiResponse(200, comment, "Add Question comment  successfully")
      );
  }
);

const AddAnswerComment = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const { content } = commentSchema.parse(req.body);
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, comment, "Add Answer comment successfully"));
  }
);

const getAllBlogComment = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
...
const getAllQuestionComment = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const { page = 1, limit = 10 } = req.query;
    const { QuestionId } = req.params;
    ...
    return res
      .status(200)
      .json(
        new ApiResponse(200, comment, "get all question comment successfully")
      );
  }
);

const getAllAnswerComment = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const { page = 1, limit = 10 } = req.query;
    const { AnswerId } = req.params;
    ...
    return res
      .status(200)
      .json(
        new ApiResponse(200, comment, "get all answer comment successfully")
      );
  }
);
